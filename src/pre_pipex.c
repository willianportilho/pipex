...
/*   Updated: 2022/07/30 20:43:15 by wportilh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_cmd(char *argv[], t_data *data)
{
	...
	{
		temp = ft_strjoin(data->path.all_path[i], ft_strjoin("/", data->arg.cmd[0]));
		temp2 = ft_strjoin(data->path.all_path[i++], ft_strjoin("/", data->arg.cmd2[0]));
